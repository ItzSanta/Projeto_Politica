...
class PoliticasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @politica.save
        format.html { redirect_to @politica, notice: "Politica was successfully created." }
  ...
  def update
    respond_to do |format|
      if @politica.update(politica_params)
        format.html { redirect_to @politica, notice: "Politica was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to politicas_path, status: :see_other, notice: "Politica was successfully destroyed." }
  ...
  private
    ...
    def politica_params
      params.require(:politica).permit(:titulo, :conteudo, :analise)
    end
